...
//
//  Attribution: the CheckForUpdatesViewModel / CheckForUpdatesView pair is
//  adapted from the Sparkle project's SwiftUI sample code, licensed MIT.
//  See Frameworks/Sparkle.framework/LICENSE for the full notice.
//
